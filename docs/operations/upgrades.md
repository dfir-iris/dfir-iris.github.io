...
```
6. Pull the last changes from the repository, checkout to `v1.4.3`, build and run. 
...
### v1.4.2
A patch already exists for this version. Please directly upgrade to [v1.4.3](#v143)
